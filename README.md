...
In this study, the input data were 44-gauge stations with temporal series of 408 months (34 years), NLPCA was used to reduce the temporal dimensionality of the dataset to five NLPC’s using a network with a [408-200-25-5] topology. 
...
<a id='1'>[1]</a> T. Canchala, Y. Carvajal, W. Alfonso, W. Loaiza, E. Caicedo. "Regionalization of monthly rainfall in southwestern Colombia using neural networks." MethodsX. 2020.

<a id='2'>[2]</a> T. Canchala, Y. Carvajal, W. Alfonso, W. Loaiza, E. Caicedo. "Estimation of missing data of monthly rainfall in southwestern Colombia using artificial neural networks."  Data in Brief, Vol. 26, pp. 104517. October 2019.

<a id='3'>[3]</a> M. A. Kramer, "Nonlinear principal component analysis using autoassociative neural networks," AIChE journal, vol. 37, pp. 233-243, 1991.

<a id='4'>[4]</a> T. Kohonen, "Self-Organizing Maps," Information Sciences. Berlin: Springer, vol. 30, 2001.

<a id='5'>[5]</a> T. Kohonen, "Self-organized formation of topologically correct feature maps," Biological cybernetics, vol. 43, pp. 59-69, 1982.

<a id='6'>[6]</a> K.-C. Hsu and S.-T. Li, "Clustering spatial–temporal precipitation data using wavelet transform and self-organizing map neural network," Advances in Water Resources, vol. 33, pp. 190-400,42010.

<a id='7'>[7]</a> F. Farsadnia, M. R. Kamrood, A. M. Nia, R. Modarres, M. T. Bray, D. Han, et al., "Identification of homogeneous regions for regionalization of watersheds by two-level self-organizing feature maps," Journal of hydrology, vol. 509, pp. 387-397, 2014.
